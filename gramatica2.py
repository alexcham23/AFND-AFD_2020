...
from gramatica import evalcadenas
import Archivo
import os
NT=[]
nombre=""
...
def pedirnombre(nombr):
    global NT,Terminales,inicialNT,Production,lista2,evalcadenas,NOT,estadoA,estadoB,nombre
    nombre=nombr
    if nombre !="" or nombre!="\t" :
        NT.clear()
        Terminales.clear()
        ...
        ruta.clear()
        expandir.clear() 
        guardar=nombre,NT,Terminales,inicialNT,Production,original
